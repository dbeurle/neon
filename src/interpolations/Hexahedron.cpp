...
void Hexahedron20::precompute_shape_functions()
{
    ...
    numerical_quadrature->evaluate([&](auto const& coordinate) {
        ...
        N(0) = eta * xi * zeta * (eta - 1.0) * (xi - 1.0) * (zeta - 1.0) / 8.0;
        N(1) = eta * xi * zeta * (eta - 1.0) * (xi + 1.0) * (zeta - 1.0) / 8.0;
        N(2) = eta * xi * zeta * (eta + 1.0) * (xi + 1.0) * (zeta - 1.0) / 8.0;
        N(3) = eta * xi * zeta * (eta + 1.0) * (xi - 1.0) * (zeta - 1.0) / 8.0;
        N(4) = eta * xi * zeta * (eta - 1.0) * (xi - 1.0) * (zeta + 1.0) / 8.0;
        N(5) = eta * xi * zeta * (eta - 1.0) * (xi + 1.0) * (zeta + 1.0) / 8.0;
        N(6) = eta * xi * zeta * (eta + 1.0) * (xi + 1.0) * (zeta + 1.0) / 8.0;
        N(7) = eta * xi * zeta * (eta + 1.0) * (xi - 1.0) * (zeta + 1.0) / 8.0;
        N(8) = -eta * zeta * (eta - 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta - 1.0) / 4.0;
        N(9) = -xi * zeta * (eta - 1.0) * (eta + 1.0) * (xi + 1.0) * (zeta - 1.0) / 4.0;
        N(10) = -eta * zeta * (eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta - 1.0) / 4.0;
        N(11) = -xi * zeta * (eta - 1.0) * (eta + 1.0) * (xi - 1.0) * (zeta - 1.0) / 4.0;
        N(12) = -eta * zeta * (eta - 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta + 1.0) / 4.0;
        N(13) = -xi * zeta * (eta - 1.0) * (eta + 1.0) * (xi + 1.0) * (zeta + 1.0) / 4.0;
        N(14) = -eta * zeta * (eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta + 1.0) / 4.0;
        N(15) = -xi * zeta * (eta - 1.0) * (eta + 1.0) * (xi - 1.0) * (zeta + 1.0) / 4.0;
        N(16) = -eta * xi * (eta - 1.0) * (xi - 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        N(17) = -eta * xi * (eta - 1.0) * (xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        N(18) = -eta * xi * (eta + 1.0) * (xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        N(19) = -eta * xi * (eta + 1.0) * (xi - 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;

        rhea(0, 0) = eta * zeta * (eta - 1.0) * (2 * xi - 1.0) * (zeta - 1.0) / 8.0;
        rhea(1, 0) = eta * zeta * (eta - 1.0) * (2 * xi + 1.0) * (zeta - 1.0) / 8.0;
        rhea(2, 0) = eta * zeta * (eta + 1.0) * (2 * xi + 1.0) * (zeta - 1.0) / 8.0;
        rhea(3, 0) = eta * zeta * (eta + 1.0) * (2 * xi - 1.0) * (zeta - 1.0) / 8.0;
        rhea(4, 0) = eta * zeta * (eta - 1.0) * (2 * xi - 1.0) * (zeta + 1.0) / 8.0;
        rhea(5, 0) = eta * zeta * (eta - 1.0) * (2 * xi + 1.0) * (zeta + 1.0) / 8.0;
        rhea(6, 0) = eta * zeta * (eta + 1.0) * (2 * xi + 1.0) * (zeta + 1.0) / 8.0;
        rhea(7, 0) = eta * zeta * (eta + 1.0) * (2 * xi - 1.0) * (zeta + 1.0) / 8.0;
        rhea(8, 0) = -eta * xi * zeta * (eta - 1.0) * (zeta - 1.0) / 2.0;
        rhea(9, 0) = -zeta * (eta - 1.0) * (eta + 1.0) * (2 * xi + 1.0) * (zeta - 1.0) / 4.0;
        rhea(10, 0) = -eta * xi * zeta * (eta + 1.0) * (zeta - 1.0) / 2.0;
        rhea(11, 0) = zeta * (eta - 1.0) * (eta + 1.0) * (-2 * xi + 1.0) * (zeta - 1.0) / 4.0;
        rhea(12, 0) = -eta * xi * zeta * (eta - 1.0) * (zeta + 1.0) / 2.0;
        rhea(13, 0) = -zeta * (eta - 1.0) * (eta + 1.0) * (2 * xi + 1.0) * (zeta + 1.0) / 4.0;
        rhea(14, 0) = -eta * xi * zeta * (eta + 1.0) * (zeta + 1.0) / 2.0;
        rhea(15, 0) = zeta * (eta - 1.0) * (eta + 1.0) * (-2 * xi + 1.0) * (zeta + 1.0) / 4.0;
        rhea(16, 0) = eta * (eta - 1.0) * (-2 * xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        rhea(17, 0) = -eta * (eta - 1.0) * (2 * xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        rhea(18, 0) = -eta * (eta + 1.0) * (2 * xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        rhea(19, 0) = eta * (eta + 1.0) * (-2 * xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;

        rhea(0, 1) = xi * zeta * (2 * eta - 1.0) * (xi - 1.0) * (zeta - 1.0) / 8.0;
        rhea(1, 1) = xi * zeta * (2 * eta - 1.0) * (xi + 1.0) * (zeta - 1.0) / 8.0;
        rhea(2, 1) = xi * zeta * (2 * eta + 1.0) * (xi + 1.0) * (zeta - 1.0) / 8.0;
        rhea(3, 1) = xi * zeta * (2 * eta + 1.0) * (xi - 1.0) * (zeta - 1.0) / 8.0;
        rhea(4, 1) = xi * zeta * (2 * eta - 1.0) * (xi - 1.0) * (zeta + 1.0) / 8.0;
        rhea(5, 1) = xi * zeta * (2 * eta - 1.0) * (xi + 1.0) * (zeta + 1.0) / 8.0;
        rhea(6, 1) = xi * zeta * (2 * eta + 1.0) * (xi + 1.0) * (zeta + 1.0) / 8.0;
        rhea(7, 1) = xi * zeta * (2 * eta + 1.0) * (xi - 1.0) * (zeta + 1.0) / 8.0;
        rhea(8, 1) = zeta * (-2 * eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta - 1.0) / 4.0;
        rhea(9, 1) = -eta * xi * zeta * (xi + 1.0) * (zeta - 1.0) / 2.0;
        rhea(10, 1) = -zeta * (2 * eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta - 1.0) / 4.0;
        rhea(11, 1) = -eta * xi * zeta * (xi - 1.0) * (zeta - 1.0) / 2.0;
        rhea(12, 1) = zeta * (-2 * eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta + 1.0) / 4.0;
        rhea(13, 1) = -eta * xi * zeta * (xi + 1.0) * (zeta + 1.0) / 2.0;
        rhea(14, 1) = -zeta * (2 * eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (zeta + 1.0) / 4.0;
        rhea(15, 1) = -eta * xi * zeta * (xi - 1.0) * (zeta + 1.0) / 2.0;
        rhea(16, 1) = xi * (-2 * eta + 1.0) * (xi - 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        rhea(17, 1) = xi * (-2 * eta + 1.0) * (xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        rhea(18, 1) = -xi * (2 * eta + 1.0) * (xi + 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;
        rhea(19, 1) = -xi * (2 * eta + 1.0) * (xi - 1.0) * (zeta - 1.0) * (zeta + 1.0) / 4.0;

        rhea(0, 2) = eta * xi * (eta - 1.0) * (xi - 1.0) * (2 * zeta - 1.0) / 8.0;
        rhea(1, 2) = eta * xi * (eta - 1.0) * (xi + 1.0) * (2 * zeta - 1.0) / 8.0;
        rhea(2, 2) = eta * xi * (eta + 1.0) * (xi + 1.0) * (2 * zeta - 1.0) / 8.0;
        rhea(3, 2) = eta * xi * (eta + 1.0) * (xi - 1.0) * (2 * zeta - 1.0) / 8.0;
        rhea(4, 2) = eta * xi * (eta - 1.0) * (xi - 1.0) * (2 * zeta + 1.0) / 8.0;
        rhea(5, 2) = eta * xi * (eta - 1.0) * (xi + 1.0) * (2 * zeta + 1.0) / 8.0;
        rhea(6, 2) = eta * xi * (eta + 1.0) * (xi + 1.0) * (2 * zeta + 1.0) / 8.0;
        rhea(7, 2) = eta * xi * (eta + 1.0) * (xi - 1.0) * (2 * zeta + 1.0) / 8.0;
        rhea(8, 2) = eta * (eta - 1.0) * (xi - 1.0) * (xi + 1.0) * (-2 * zeta + 1.0) / 4.0;
        rhea(9, 2) = xi * (eta - 1.0) * (eta + 1.0) * (xi + 1.0) * (-2 * zeta + 1.0) / 4.0;
        rhea(10, 2) = eta * (eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (-2 * zeta + 1.0) / 4.0;
        rhea(11, 2) = xi * (eta - 1.0) * (eta + 1.0) * (xi - 1.0) * (-2 * zeta + 1.0) / 4.0;
        rhea(12, 2) = -eta * (eta - 1.0) * (xi - 1.0) * (xi + 1.0) * (2 * zeta + 1.0) / 4.0;
        rhea(13, 2) = -xi * (eta - 1.0) * (eta + 1.0) * (xi + 1.0) * (2 * zeta + 1.0) / 4.0;
        rhea(14, 2) = -eta * (eta + 1.0) * (xi - 1.0) * (xi + 1.0) * (2 * zeta + 1.0) / 4.0;
        rhea(15, 2) = -xi * (eta - 1.0) * (eta + 1.0) * (xi - 1.0) * (2 * zeta + 1.0) / 4.0;
        rhea(16, 2) = -eta * xi * zeta * (eta - 1.0) * (xi - 1.0) / 2.0;
        rhea(17, 2) = -eta * xi * zeta * (eta - 1.0) * (xi + 1.0) / 2.0;
        rhea(18, 2) = -eta * xi * zeta * (eta + 1.0) * (xi + 1.0) / 2.0;
        rhea(19, 2) = -eta * xi * zeta * (eta + 1.0) * (xi - 1.0) / 2.0;
