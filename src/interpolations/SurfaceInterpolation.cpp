...
Matrix SurfaceInterpolation::project_to_plane(Matrix const& nodal_coordinates) const
{
    ...
    Matrix plane_coordinates = Matrix::Zero(2, lnodes);

    auto const normal = this->unit_outward_normal(nodal_coordinates);
...
Vector3 SurfaceInterpolation::unit_outward_normal(Matrix const& nodal_coordinates) const
{
