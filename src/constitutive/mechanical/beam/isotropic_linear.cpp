...
void isotropic_linear::update_internal_variables()
{
    ...
    auto [D_b, D_s] = variables->get(internal_variable_type::second::bending_stiffness,
                                     internal_variable_type::second::shear_stiffness);

    auto [D_a, D_t] = variables->get(internal_variable_type::scalar::axial_stiffness,
                                     internal_variable_type::scalar::torsional_stiffness);

    // Access the geometric properties at the quadrature points
    auto [shear_area_1,
          shear_area_2,
          cross_sectional_area] = variables->get(internal_variable_type::scalar::shear_area_1,
                                                 internal_variable_type::scalar::shear_area_2,
                                                 internal_variable_type::scalar::cross_sectional_area);
    auto [second_moment_area_1,
          second_moment_area_2] = variables->get(internal_variable_type::scalar::second_moment_area_1,
