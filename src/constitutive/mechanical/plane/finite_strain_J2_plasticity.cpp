...
// {
// finite_strain_J2_plasticity::finite_strain_J2_plasticity(std::shared_ptr<InternalVariables>&
// variables,
...
//          von_mises_stresses] =
//          variables->fetch(InternalVariables::Scalar::EffectivePlasticStrain,
...
//         cauchy_stress = compute_cauchy_stress(material.shear_modulus(), material.lambda(),
//         log_strain_e)
//                         / J;
//
...
//         if (auto const f = evaluate_yield_function(von_mises, accumulated_plastic_strain); f <=
//         0.0)
//         {
...
//         auto const plastic_increment = perform_radial_return(von_mises,
...
//     matrix3 const D = voigt_to_mandel(C);
//     matrix3 const L = voigt_to_mandel(compute_L(Be_trial));
//     matrix3 const B = voigt_to_mandel(compute_B(Be_trial));
//
//     matrix3 const H = compute_H(cauchy_stress);
//
//     return 1.0 / (2.0 * J) * D * L * B - H;
// }
//
// std::tuple<vector3, std::array<matrix3, 3>, bool, std::array<int, 3>>
...
//     matrix6 B(6, 6);
//     // clang-format off
//     B << 2 * Be_trial(0, 0),                  0,                  0,                  0, 2 *
//     Be_trial(0, 2), 2 * Be_trial(0, 1),
//                           0, 2 * Be_trial(1, 1),                  0, 2 * Be_trial(1, 2),
//                           0,                  0, 0,                  0, 2 * Be_trial(2, 2),
//                           0,                  0,                  0, 0, 2 * Be_trial(1, 2),
//                           0,     Be_trial(2, 2),                  0,                  0,
//          2 * Be_trial(0, 2),                  0,                  0,                  0,
//          Be_trial(2, 2),      Be_trial(2, 1), 2 * Be_trial(0, 1),                  0,
//          0,                  0,     Be_trial(2, 1),      Be_trial(1, 1);
//     // clang-format on
//     return B;
// }
//
...
//     matrix6 dx2_dx(6, 6);
//     // clang-format off
//     dx2_dx << 2 * X(0, 0),         0.0,         0.0,               0.0,           X(2, 0),
//     X(1, 0),
//                       0.0, 2 * X(1, 1),         0.0,           X(2, 1),               0.0,
//                       X(1, 0), 0.0,         0.0, 2 * X(2, 2),           X(2, 1),           X(2,
//                       0),              0.0, 0.0,     X(2, 1),     X(2, 1), X(1, 1) + X(2, 2),
//                       X(1, 0),              0.0,
//                   X(2, 0),           0,     X(2, 0),           X(1, 0), X(0, 0) + X(2, 2),
//                   X(1, 2), X(1, 0),     X(1, 0),         0.0,               0.0,           X(1,
//                   2), X(0, 0) + X(1, 1);
//     // clang-format on
//     return dx2_dx;
// }
