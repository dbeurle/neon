...
//  */
// class finite_strain_J2_plasticity : public isotropic_linear_elasticity
// {
// public:
...
//        \f}
//      */
//     matrix3 compute_L(matrix2 const& Be_trial) const;
//
//     /**
...
//     compute_eigenvalues_eigenprojections(
...
//
// protected:
//     matrix3 const Isym = voigt::kinematic::fourth_order_identity();
//     matrix3 const M = mandel_transformation();
// };
// }
