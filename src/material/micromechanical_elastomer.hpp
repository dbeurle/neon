...
protected:
    /// Segment scission probability
    double scission_probability{0.0};
    /// Rate of new crosslinks
    double crosslink_growth_rate{0.0};
    /// Rate of average segments per chain decay
