...
{
    if (material_data["YieldStress"].empty())
...
double IsotropicElasticPlastic::hardening_modulus(double effective_strain) const
{
    return H;
}

double IsotropicElasticPlastic::kinematic_modulus(double effective_strain) const
{
    return K;
}
}
