...
// }
//
// void femStaticMatrix::compute_external_flux(double const load_factor)
// {
//     auto start = std::chrono::high_resolution_clock::now();
//
//     f.setZero();
//
//     for (auto const & [ name, fluxes ] : fem_mesh.flux_boundaries())
//     {
//         for (auto const& flux : fluxes)
//         {
//             for (auto const& mesh : flux.boundaries())
//             {
//                 for (auto element = 0; element < mesh.elements(); ++element)
//                 {
//                     auto const & [ dofs, fe ] = mesh.external_flux(element);
//
