...
TEST_CASE("trapezoidal method")
{
    ...
    REQUIRE(trapezoidal(0.0, 1.0, 1.0, [](auto i) { return i; }) == Approx(0.5));
    REQUIRE(trapezoidal(0.0, 1.0, 1.0e-6, [](auto i) { return i * i; }) == Approx(1.0 / 3.0));
    REQUIRE(trapezoidal(0.0, 1.0, 1.0e-6, [](auto i) { return std::pow(i, 3); }) == Approx(1.0 / 4.0));
}
